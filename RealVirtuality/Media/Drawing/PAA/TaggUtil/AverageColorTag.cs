...
{
    public class AverageColorTag : TagBase
    {
        internal const string NAME_REVERSED = "GGATCGVA";
        internal const string NAME = "AVGCTAGG";
        ...
        internal AverageColorTag(Tagg t) : base(t, NAME, DATALENGTH)
        {
