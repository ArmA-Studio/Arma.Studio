...
namespace ArmA.Studio.DataContext
{
    ...
    {
        public override string Title => Properties.Localization.PanelDisplayName_CallStack;
        public override string Icon => @"Resources\Pictograms\CallStackWindow\CallStackWindow_16x.png";
