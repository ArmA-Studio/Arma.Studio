...
{
    public class PluginMain : IPlugin, IDockableProvider, ILogHandler
    {
        ...
        public IEnumerable<DockableInfo> Dockables => new DockableInfo[] {
            DockableInfo.Create(Properties.Language.OutputWindow, ECreationMode.Anchorable, () => new OutputWindowDataContext())
        };
        ...
        #endregion
        #region ILogHandler
        public void SetLogCollection(LoggerCollection loggers)
        {
            Loggers = loggers;
        }
        #endregion
